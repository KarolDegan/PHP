...
class PdoStudentRepository implements StudentRepository
{
    ...
    {
        $studentDataList = $stmt->fetchAll(PDO::FETCH_ASSOC); // pode tirar o fetch _assoc daqui porque definiu no connection
        $studentList = [];
    ...
    public function fillPhonesOf(Student $student){
